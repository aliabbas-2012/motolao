...
/**
 * This is the model class for table "moto_gallery".
 *
 * The followings are the available columns in table 'moto_gallery':
 * @property string $id
...
class MotoGallery extends DTActiveRecord {
     ...
     * @return MotoGallery the static model class
     */
    ...
    public function afterFind() {
        ...
        if (!empty($this->image_large)) {
            ...
            $this->image_url['image_large'] = Yii::app()->baseUrl . "/uploads/moto-gallery/" . $this->id;
    ...
    public function deleteldImage() {
        ...
        if (!empty($this->oldLargeImg) && $this->oldLargeImg != $this->image_large) {
            ...
            $path.= "uploads" . DIRECTORY_SEPARATOR . "moto-gallery" . DIRECTORY_SEPARATOR . $this->primaryKey . DIRECTORY_SEPARATOR;
        ...
        if (!empty($this->oldDetailImg) && $this->oldDetailImg != $this->image_detail) {
            $path = Yii::app()->basePath . DIRECTORY_SEPARATOR . ".." . DIRECTORY_SEPARATOR;
            $path.= "uploads" . DIRECTORY_SEPARATOR . "moto-gallery" . DIRECTORY_SEPARATOR . $this->primaryKey;
