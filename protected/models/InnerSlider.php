...
/**
 * This is the model class for table "inner-slider".
 *
 * The followings are the available columns in table 'inner-slider':
 * @property string $id
 ...
 */
class InnerSlider extends DTActiveRecord {
    ...
    public function attributeLabels() {
        return array(
            ...
            'same_box' => 'Heading Detail on SameBox',
    ...
    public function afterFind() {
        ...
        if (!empty($this->image_large)) {
            $this->image_url['image_large'] = Yii::app()->baseUrl . "/uploads/inner-slider/" . $this->id . "/" . $this->image_large;
        } else {
    ...
    public function uploadImages() {
        ...
        if (!empty($this->upload_insance)) {
            ...
            $folder_array = array("inner-slider", $this->getPrimaryKey());
    ...
    public function deleteldImage() {
        ...
        if (!empty($this->oldLargeImg) && $this->oldLargeImg != $this->image_large) {
            ...
            $path.= "uploads" . DIRECTORY_SEPARATOR . "inner-slider" . DIRECTORY_SEPARATOR . $this->id . DIRECTORY_SEPARATOR . $this->oldLargeImg;
